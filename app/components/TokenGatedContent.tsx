        ...
        <div className="min-h-screen">
            ...
            {showGate && (
                <main className="min-h-screen flex flex-col content-area-bg gate-screen-bg">
                    <ContentBackground />
                    <nav className="relative z-50 w-full max-w-[1200px] mx-auto px-6 py-6 flex items-center justify-between opacity-0 animate-fade-in-up">
                    ...
                    <section className="flex-1 flex flex-col items-center justify-center px-6 py-20 lg:py-28 w-full max-w-[720px] mx-auto text-center">
                        ...
                        <p className="text-[var(--text-secondary)] text-[1.1rem] leading-relaxed mb-12 max-w-[540px] mx-auto opacity-0 animate-fade-in-up animate-delay-100">
                            {t(lang, 'heroDesc', { amount: String(REQUIRED_AMOUNT) })}
                        </p>
                        ...
                        <div className="w-full max-w-[380px] mx-auto flex flex-col items-center opacity-0 animate-fade-in-up animate-delay-200">
                            {!connected ? (
                                <div className="flex flex-col gap-4">
                                    {hasDeeplinkSupport ? (
                                        <>
                                            ...
                                            <p className="text-xs text-[var(--text-muted)] mt-2">{t(lang, 'or')}</p>
                                            <button
                                                type="button"
                                        ...
                                        <>
                                            ...
                                            <p className="text-sm text-[var(--text-muted)] text-center mt-3">
                                                {isMobile ? t(lang, 'connectHint') : t(lang, 'connectHintDesktop')}
                                            </p>
                                        </>
                                    )}
                                </div>
                                ...
                                <div className="p-8 flex flex-col items-center gap-4">
                                    ...
                                    <span className="text-sm text-[var(--text-muted)]">{t(lang, 'checkingBalance')}</span>
                                </div>
                            ) : isBlocked ? (
                                <div className="p-8 text-center border border-[var(--border)] rounded-xl bg-[var(--bg-card)]/60 backdrop-blur-xl">
                                    <p className="text-[var(--foreground)] font-medium mb-2">{t(lang, 'blocked')}</p>
                                    <p className="text-sm text-[var(--text-muted)]">{t(lang, 'blockedDesc')}</p>
                                </div>
                            ) : !hasAccess ? (
                                <div className="p-8 text-center border border-[var(--border)] rounded-xl bg-[var(--bg-card)]/60 backdrop-blur-xl">
                                    <p className="text-[var(--foreground)] font-medium mb-2">{t(lang, 'insufficientTokens')}</p>
                                    <p className="text-sm text-[var(--text-muted)] mb-4">
                                        {t(lang, 'insufficientDesc', { balance: Math.floor(tokenBalance || 0).toLocaleString(), amount: String(REQUIRED_AMOUNT) })}
                                    </p>
                                ...
                                <div className="p-8 text-center border border-[var(--border)]/60 rounded-xl bg-[var(--bg-card)]/60 backdrop-blur-xl">
                                    <p className="text-[var(--foreground)] font-medium mb-6">{t(lang, 'accessGranted')}</p>
                                    <Link
                                        href="/exclusive"
                    ...
                    <section className="px-6 py-8">
                        <div className="max-w-[1200px] mx-auto border-t border-[var(--border)]/80 pt-8 text-center">
                            <p className="text-xs text-[var(--text-muted)] uppercase tracking-widest">
                                {t(lang, 'tech', { amount: String(REQUIRED_AMOUNT) })}
                            </p>
                        </div>
                    </section>
                        ...
                        <div className="max-w-[1200px] mx-auto border-t border-[var(--border)]/80 pt-16 lg:pt-24">
                            ...
                            <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
                                <div className="p-6 lg:p-8 rounded-2xl bg-[var(--bg-card)]/60 backdrop-blur-xl border border-[var(--border)]/60 hover:border-[var(--border-hover)] transition-colors">
                                    ...
                                    <h3 className="font-display text-lg font-semibold text-[var(--foreground)] mb-2">{t(lang, 'earlyReleases')}</h3>
                                ...
                                <div className="p-6 lg:p-8 rounded-2xl bg-[var(--bg-card)]/60 backdrop-blur-xl border border-[var(--border)]/60 hover:border-[var(--border-hover)] transition-colors">
                                    ...
                                    <h3 className="font-display text-lg font-semibold text-[var(--foreground)] mb-2">{t(lang, 'favorites')}</h3>
                                    <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
                                ...
                                <div className="p-6 lg:p-8 rounded-2xl bg-[var(--bg-card)]/60 backdrop-blur-xl border border-[var(--border)]/60 hover:border-[var(--border-hover)] transition-colors">
                                    ...
                                    <h3 className="font-display text-lg font-semibold text-[var(--foreground)] mb-2">{t(lang, 'secure')}</h3>
                                    <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
                                        {t(lang, 'secureDesc')}
                                    </p>
                                </div>
                    ...
                    <section id="ambassadors" className="px-6 pb-16 lg:pb-24">
                        <div className="max-w-[1200px] mx-auto border-t border-[var(--border)]/80 pt-16 lg:pt-24">
                            <h2 className="font-display text-2xl lg:text-3xl font-semibold text-[var(--foreground)] text-center mb-12">
                                {t(lang, 'ambassadorsTitle')}
                            </h2>
                            <div className="max-w-[640px] mx-auto text-center">
                                <p className="text-[var(--text-secondary)] leading-relaxed mb-6">
                                    {t(lang, 'ambassadorsDesc')}
                                </p>
                        ...
                        <div className="max-w-[1200px] mx-auto px-6 border-t border-[var(--border)]/80 pt-16 lg:pt-20">
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-2 text-sm text-[var(--text-secondary)]">
                                        <li><a href="#about" className="hover:text-[var(--foreground)] transition-colors">{t(lang, 'navAbout')}</a></li>
                                        <li><a href="#ambassadors" className="hover:text-[var(--foreground)] transition-colors">{t(lang, 'navAmbassadors')}</a></li>
                            ...
                            <div className="mt-12 pt-8 border-t border-[var(--border)]/80 flex flex-col sm:flex-row items-center justify-between gap-4">
                                ...
                                {typeof window !== 'undefined' && /localhost|127\.0\.0\.1/.test(window.location.hostname) && (
                                    <p className="text-xs text-[var(--text-muted)]/70">
                                        {t(lang, 'devAccess')} <code className="px-1 py-0.5 bg-[var(--bg-secondary)] rounded">?dev_access=1</code>
                                    </p>
                                )}
                            </div>
                        </div>
